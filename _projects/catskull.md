...
<div class="d-flex justify-content-center flex-column align-items-center">
    <div class="row">
        <div class="col-sm mt-3 mt-md-0">
            {% include figure.html path="assets/img/catskull_store.jpg" title="Catskull Webfront" class="img-fluid rounded z-depth-1" %}
        </div>
    </div>
