...
<div class="d-flex justify-content-center flex-column align-items-center">
    <div class="row">
        <div class="col-sm mt-3 mt-md-0">
            {% include figure.html path="assets/img/plasma_sound.gif" title="radiation pattern of plasma sound" class="img-fluid rounded z-depth-1" %}
        </div>
    </div>
...
<div class="d-flex justify-content-center flex-column align-items-center">
    <div class="row">
        <div class="col-sm mt-3 mt-md-0">
            {% include figure.html path="assets/img/1MHZ_Flicker.jpg" title="scanned plasma image of a square" class="img-fluid rounded z-depth-1" %}
        </div>
    </div>
    <div class="caption text-center">
